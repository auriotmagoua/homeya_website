      ...
      <div className="max-w-6xl mx-auto bg-black rounded-3xl overflow-hidden relative shadow-2xl">
        ...
        <div className="relative z-10 p-8 sm:p-10 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-start gap-5 max-w-xl">
            {/* Badge Logo HO */}
            <div className="w-14 h-14 sm:w-16 sm:h-16 bg-[#F77500] rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg">
            ...
            <div className="text-left text-white space-y-2">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-extrabold tracking-tight leading-snug">
                Prêt à vivre dans le logement qui vous ressemble ?
              </h2>
